...
const LEAD_TOOLS: Tool[] = [
  {
    name: "spawn_coworker",
    description:
      "Spawn a new coworker agent. The daemon assigns a unique name from the Manhattan avenue naming scheme.",
    inputSchema: {
  ...
  },
  {
    ...
    description:
      "Gracefully shutdown a coworker agent by name. The coworker will finish current work and exit.",
    inputSchema: {
      type: "object" as const,
      properties: {
        name: {
  ...
  },
  {
    name: "broadcast",
    description:
      "Post an announcement to the team channel. Use for important updates that all coworkers should see.",
    inputSchema: {
      type: "object" as const,
      properties: {
        message: {
...
const COWORKER_TOOLS: Tool[] = [
  {
    name: "post_message",
    description:
      "Post a message to the team channel. Also returns recent messages for context.",
    inputSchema: {
      type: "object" as const,
      properties: {
        message: {
  ...
  },
  {
    name: "read_channel",
    description:
      "Read recent messages from the team channel. Returns messages since your last read.",
    inputSchema: {
      type: "object" as const,
      properties: {
        all: {
  ...
  },
  {
    name: "claim_task",
    description:
      "Claim a task by ID. This marks you as the owner and prevents others from working on it.",
    inputSchema: {
      type: "object" as const,
      properties: {
        task_id: {
  ...
  },
  {
    name: "request_review",
    description:
      "Request another coworker to review your PR. Posts a review request to the channel.",
    inputSchema: {
      type: "object" as const,
      properties: {
        pr_number: {
        ...
        reviewer: {
          type: "string",
          description:
            "Optional: specific coworker to request review from. If not specified, any available coworker can pick it up.",
        },
        description: {
          type: "string",
          description:
            "Brief description of what to focus on in the review",
        },
      },
      required: ["pr_number"],
    },
...
const SHARED_TOOLS: Tool[] = [
  {
    name: "list_coworkers",
    description:
      "List all active coworkers with their current status and assigned work.",
    inputSchema: {
      type: "object" as const,
      properties: {},
      required: [],
  ...
  },
  {
    ...
    description:
      "Check the status of pull requests including CI status and review state.",
    inputSchema: {
      type: "object" as const,
      properties: {
        pr_number: {
          type: "string",
          description:
            "Optional: specific PR number to check. If not provided, lists all open PRs.",
        },
      },
      required: [],
    },
