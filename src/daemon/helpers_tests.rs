...
// =========================================================================
// should_route_to_main_channel tests
// =========================================================================

#[test]
fn test_should_route_to_main_channel_at_lead() {
    assert!(should_route_to_main_channel("@lead please help", "midtown"));
    assert!(should_route_to_main_channel("Hey @lead look at this", "midtown"));
}

#[test]
fn test_should_route_to_main_channel_at_user() {
    assert!(should_route_to_main_channel("@user check this out", "midtown"));
}

#[test]
fn test_should_route_to_main_channel_project_name_mention() {
    assert!(should_route_to_main_channel("@midtown can you triage this?", "midtown"));
    assert!(should_route_to_main_channel("Hey @Midtown look at this", "midtown"));
    // Non-matching project name should not trigger
    assert!(!should_route_to_main_channel("Working on the midtown codebase", "midtown"));
}

#[test]
fn test_should_route_to_main_channel_task_lifecycle() {
    assert!(should_route_to_main_channel("task !42 completed", "midtown"));
    assert!(should_route_to_main_channel("created task !99", "midtown"));
}

#[test]
fn test_should_route_to_main_channel_errors() {
    assert!(should_route_to_main_channel("error: compilation failed", "midtown"));
    assert!(should_route_to_main_channel("failed to build", "midtown"));
}

#[test]
fn test_should_route_to_main_channel_escalations() {
    assert!(should_route_to_main_channel("I'm blocked on this", "midtown"));
    assert!(should_route_to_main_channel("need help with auth", "midtown"));
}

#[test]
fn test_should_route_to_main_channel_normal_message() {
    assert!(!should_route_to_main_channel("Working on the feature", "midtown"));
    assert!(!should_route_to_main_channel("Pushed a commit", "midtown"));
}
