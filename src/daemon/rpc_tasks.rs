...
//!
//! Handles task CRUD operations: create, update, done, metadata, claim, and request.
//! Also contains task-specific helpers like active form generation, model/channel
//! mapping, and clusterer invocation.
...
pub(super) fn generate_active_form(subject: &str) -> String {
...
pub(super) fn apply_task_model_mapping(
...
pub(super) fn apply_task_channel_mapping(
