...
//!    Loaded from `~/.claude/agents/midtown-*.md` (user-level) or
//!    `.claude/agents/midtown-*.md` (project-level) via `load_agent_definition_for_role()`,
//!    with compiled-in fallback from `agents/definitions/midtown-*.md`.
//!
