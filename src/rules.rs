...
mod tests {
    ...
    fn prompt_nudge_new_prompt_detected() {
        ...
        assert!(
            matches!(get_health(&phases, "york"), Some(SessionHealth::Prompted { fingerprint }) if fingerprint == "permission request")
        );
    }
