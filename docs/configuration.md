...
clusterer_provider = "codex"          # Optional override (falls back to specialized_provider)
...
- Specialized workers:
  ...
  - Clusterer: `execution.clusterer_provider` → `execution.specialized_provider` → `claude`
